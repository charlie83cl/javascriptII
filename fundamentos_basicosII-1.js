...
/*
3. Imprime (print) uno, devuelve (return) 
otro- Crea una función para un array de números.
La función debería imprimir (print) el penúltimo valor y 
devolver (return) el primer valor impar.
*/
function imprunodevotro(arr){
...
console.log(imprunodevotro([0,2,1,4,3]));

/*
4. Doble Visión - Dado un array, 
crea una función que devuelva un nuevo array 
donde cada valor se duplique. Entonces, doble([1,2,3]) 
...
/*
5. Contar Positivos -  Dado un array de números, 
